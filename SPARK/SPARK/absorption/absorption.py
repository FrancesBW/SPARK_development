...
class lbfgs_abs(object):
    ...
    def run(self, n_gauss=18, lb_amp=0, ub_amp=100, lb_mu=1, ub_mu=500, lb_sig=1, ub_sig=100, lambda_Tb=1, 
        ...
        #print("Params have length: {}".format(len(params)))
        #print("Params_Tb have length: {}".format(len(params_Tb)))
        #print("Params_tau have length: {}".format(len(params_tau)))
        
        #copying two thirds of the emission initialisations and one third of the absorption 
